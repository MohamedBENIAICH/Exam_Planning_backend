...
<head>
    ...
    <title>Annulation d'examen - Surveillance</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>🚫 Annulation d'examen - Surveillance</h1>
    </div>

    <div class="content">
        <p>Bonjour {{ $recipientName }},</p>

        <p>Nous vous informons que votre mission de surveillance pour l'examen suivant a été <strong>annulée</strong> :
        </p>
        ...
        <p>Nous vous remercions pour votre disponibilité et vous prions de nous excuser pour la gêne occasionnée.</p>
