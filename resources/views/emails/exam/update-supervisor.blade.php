...
<head>
    ...
    <title>Mise à jour d'examen - Surveillance</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>📝 Mise à jour d'examen - Surveillance</h1>
    </div>

    <div class="content">
        <p>Bonjour {{ $recipientName }},</p>

        <p>Nous vous informons que des modifications ont été apportées à l'examen suivant pour lequel vous êtes
        ...
        <p>Une nouvelle convocation sera envoyée aux étudiants avec les informations mises à jour.</p>
