...
<head>
    ...
    <title>Mise à jour de concours - Professeur</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>📝 Mise à jour de concours - Professeur</h1>
    </div>

    <div class="content">
        <p>Bonjour {{ $recipientName }},</p>

        <p>Nous vous informons que des modifications ont été apportées au concours suivant :</p>
        ...
        <p><strong>Important :</strong> Veuillez prendre note de ces modifications.</p>

        <p>Les candidats ont été informés de ces changements.</p>
