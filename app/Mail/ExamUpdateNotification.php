...
class ExamUpdateNotification extends Mailable
{
     ...
     */
    public function __construct(Exam $exam, string $recipientName, string $recipientType = 'supervisor')
    {
        $this->exam = $exam;
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Mise à jour de l'examen - {$moduleName}",
        );
    }
    ...
    public function content(): Content
    {
        $view = match ($this->recipientType) {
            'supervisor' => 'emails.exam.update-supervisor',
            'professeur' => 'emails.exam.update-professeur',
            default => 'emails.exam.update-supervisor'
        };
